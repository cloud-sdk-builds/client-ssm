...
[`@aws-sdk/client-ssm`](https://www.npmjs.com/package/@aws-sdk/client-ssm/v/3.465.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm@3.465.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uj6mQuayfltPBg2efox2hiud8sSSS16ZTENMJHU19y9emJIyK2mmPuD2BadotLgs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm@3.465.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm@3.465.0/index.min.mjs": "sha384-uj6mQuayfltPBg2efox2hiud8sSSS16ZTENMJHU19y9emJIyK2mmPuD2BadotLgs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm/blob/refs/tags/3.465.0/LICENSE
```
